...
public class FeaturedFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        final ProgressBar progressBar = view.findViewById(R.id.featured_progress);
        progressBar.setIndeterminate(true);
        //    private static CulturalFragment culturalFragment;
        final RecyclerView recyclerView = view.findViewById(R.id.featured_recycler_view);
        ...
        if (bundle != null)
        {
            ...
            Log.e("FeaturedFragment", "Value of index: "+paramEventEmail);
            linearLayoutManager.scrollToPositionWithOffset(paramEventEmail, 0);
        }

        FirebaseRecyclerOptions<Event> options = new FirebaseRecyclerOptions.Builder<Event>()
                .setQuery(DatabaseUtils.getDatabaseReference().getDatabaseInstance().child("Event").orderByChild("category").equalTo("Featured"), Event.class)
                .build();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        Log.e("FeaturedFragment", "Entered FeaturedFragment");
