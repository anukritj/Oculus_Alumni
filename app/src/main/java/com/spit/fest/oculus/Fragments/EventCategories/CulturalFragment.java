...
public class CulturalFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        final ProgressBar progressBar = view.findViewById(R.id.cultural_progress);
        progressBar.setIndeterminate(true);
        //    private static CulturalFragment culturalFragment;
        final RecyclerView recyclerView = view.findViewById(R.id.cultural_recycler_view);
...
//        recyclerView.setDrawingCacheQuality(View.DRAWING_CACHE_QUALITY_HIGH);
        ...
        FirebaseRecyclerOptions<Event> options = new FirebaseRecyclerOptions.Builder<Event>()
                .setQuery(DatabaseUtils.getDatabaseReference().getDatabaseInstance().child("Event").orderByChild("category").equalTo("Cultural"), Event.class)
                .build();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        Log.e("CulturalFragment", "Entered CulturalFragment");
