...
public class TechFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        final ProgressBar progressBar = view.findViewById(R.id.tech_progress);
        progressBar.setIndeterminate(true);
        //    private static TechFragment techFragment;
        final RecyclerView recyclerView = view.findViewById(R.id.tech_recycler_view);
        ...
        if (bundle != null)
        {
            ...
            Log.e("TechFragment", "Value of index: "+paramEventEmail);
            linearLayoutManager.scrollToPositionWithOffset(paramEventEmail, 0);
        }

        FirebaseRecyclerOptions<Event> options = new FirebaseRecyclerOptions.Builder<Event>()
                .setQuery(DatabaseUtils.getDatabaseReference().getDatabaseInstance().child("Event").orderByChild("category").equalTo("Technical"), Event.class)
                .build();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        Log.e("TechFragment","Entered TechFragment");

    }

//    public static TechFragment getTechFragment() {
