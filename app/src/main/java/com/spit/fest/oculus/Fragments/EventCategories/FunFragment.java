...
public class FunFragment extends Fragment {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, ViewGroup container,
        ...
        final ProgressBar progressBar = view.findViewById(R.id.fun_progress);
        progressBar.setIndeterminate(true);
        //    private static FunFragment funFragment;
       final LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        final RecyclerView recyclerView = view.findViewById(R.id.fun_recycler_view);
        ...
        if (bundle != null)
        {
             ...
             Log.e("FunFragment", "Value of index: "+paramEventEmail);
             linearLayoutManager.scrollToPositionWithOffset(paramEventEmail, 0);
        }

        FirebaseRecyclerOptions<Event> options = new FirebaseRecyclerOptions.Builder<Event>()
                .setQuery(DatabaseUtils.getDatabaseReference().getDatabaseInstance().child("Event").orderByChild("category").equalTo("Fun"), Event.class)
                .build();
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Event, EventViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull EventViewHolder holder, int position, @NonNull Event model) {
                ...
                Log.i("FCM","Position "+Integer.toString(position)+" fromFcm"+Boolean.toString(isFromFcm));
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        Log.e("FunFragment","Entered FunFragment");

    }

//    public static FunFragment getFunFragment() {
//        if (funFragment == null)
